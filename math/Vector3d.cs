...
namespace g3
{
    public struct Vector3d : IComparable<Vector3d>, IEquatable<Vector3d>
    {
        ...
        public Vector2d xy {
            readonly get { return new Vector2d(x, y); }
            set { x = value.x; y = value.y; }
        }
        public Vector2d xz {
            readonly get { return new Vector2d(x, z); }
            set { x = value.x; z = value.y; }
        }
        public Vector2d yz {
            readonly get { return new Vector2d(y, z); }
            set { y = value.x; z = value.y; }
        }

        public readonly Vector2d ReduceDimension(int dimension)
        {
